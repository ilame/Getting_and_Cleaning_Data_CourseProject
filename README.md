...
-Step 5.From the data set in step 4, creates a second, independent tidy data set called "averages_data" with the average of each variable for each activity and each subject.
